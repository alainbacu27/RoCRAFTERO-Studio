...
local fflagSuccess, fflagValue = pcall(function() return settings():GetFFlag("MemoryTrackerInPerformanceStats") end)

StatsUtils.FFlagMemoryTrackerInPerformanceStats = (fflagSuccess and fflagValue)

-- Enums
StatsUtils.StatType_PlaceMemory =       "st_PlaceMemory"
...
StatsUtils.AllStatTypes = {
  StatsUtils.StatType_PlaceMemory,
...
StatsUtils.StatNames = {
  [StatsUtils.StatType_PlaceMemory] = "PlaceMemory",
...
StatsUtils.StatMaxNames = {
  [StatsUtils.StatType_PlaceMemory] = "MaxPlaceMemory",
...
StatsUtils.TypeToName = {
  [StatsUtils.StatType_PlaceMemory] = "Place Memory",
  [StatsUtils.StatType_CPU] = "CPU",
  [StatsUtils.StatType_GPU] = "GPU",
...
StatsUtils.TypeToShortName = {
  [StatsUtils.StatType_PlaceMemory] = "PMem",
  [StatsUtils.StatType_CPU] = "CPU",
  [StatsUtils.StatType_GPU] = "GPU",
  [StatsUtils.StatType_NetworkSent] = "Sent",
...
if (not StatsUtils.FFlagMemoryTrackerInPerformanceStats) then
  -- Fix up to use old memory naming stuff.
  StatsUtils.StatNames[StatsUtils.StatType_PlaceMemory] = "Memory"
  StatsUtils.StatMaxNames[StatsUtils.StatType_PlaceMemory] = "MaxMemory"
  StatsUtils.TypeToName[StatsUtils.StatType_PlaceMemory] = "Memory"
  StatsUtils.TypeToShortName[StatsUtils.StatType_PlaceMemory] = "Mem"
end
...
function StatsUtils.FormatTypedValue(value, statType)   
  if statType == StatsUtils.StatType_PlaceMemory then 
