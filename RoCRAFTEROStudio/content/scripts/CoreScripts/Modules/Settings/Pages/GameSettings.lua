...
local function Initialize()
  ...
  local function createMouseOptions()
    ...
    local function translateEngineMouseSensitivityToGui(engineSensitivity)
      local sqrtValue = 75.0 * engineSensitivity - 11.0
      if sqrtValue < 0 then
        return 0
      end
    ...
    if not AdvancedEnabled then
      ...
      local SliderLabel = "Mouse Sensitivity"
      ...
      this.MouseAdvancedEntry = utility:AddNewRow(this, "Mouse Sensitivity", "Slider", AdvancedMouseSteps, startMouseLevel)
